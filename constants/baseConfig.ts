export const baseConfig = {
  ...
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_LABEL_FONT_COLOR: "black",
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_LABEL_BACKGROUND_COLOR: "white",
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_LABEL:
    "Los créditos son un estimado de la carga que significan los cursos a tomar",
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_WARNING_LABEL_FONT_COLOR: "white",
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_WARNING_LABEL_BACKGROUND_COLOR:
    "red.500",
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP_WARNING_LABEL:
  ...
  FOREPLAN_SUMMARY_WAFFLE_IS_STUDENT_CLUSTER_BORDER: "1px solid white",
  FOREPLAN_SUMMARY_WAFFLE_IS_STUDENT_CLUSTER_BORDER_WIDTH: 1,
  FOREPLAN_SUMMARY_WAFFLE_IS_STUDENT_CLUSTER_LABEL: "rendimiento similar",
  FOREPLAN_SUMMARY_WAFFLE_IS_STUDENT_CLUSTER_LABEL_COLOR: "white",
  FOREPLAN_SUMMARY_WAFFLE_LABEL_COLOR: "white",
  FOREPLAN_SUMMARY_WAFFLE_MARGIN_TOP: "7px",
  FOREPLAN_SUMMARY_WAFFLE_PADDING: "4px",
