export const baseConfig = {
  ...
  FOREPLAN_SUMMARY_ADVICE_CREDITS_HELP: "Lorem Ipsum",
  ...
  FOREPLAN_SUMMARY_BADGE_COURSE_CREDITS_WIDTH: [
    { min: 0, max: 0, width: "7.9em" },
    { min: 1, max: 2, width: "8.5em" },
    { min: 3, max: 4, width: "9em" },
    { min: 5, max: 6, width: "9.5em" },
    { min: 7, max: 12, width: "10em" },
    { min: 13, max: 999, width: "10.5em" },
  ],
