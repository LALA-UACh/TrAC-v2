...
export const GRAPHQL_URL =
  typeof window === "undefined" ? "http://localhost:3000/api/graphql" : "/api/graphql";
...
export const DROPOUT_PREDICTION_DESCRIPTION = "El sistema estima una probabilidad de abandono de";
